...
public class RepositoryBotService implements BotService {
    ...
    private final TelegramService telegramApiService;

    public RepositoryBotService(BotDao botDao, TelegramService telegramApiService) {
        this.botDao = botDao;
    ...
    public void doGetMeRequest(Bot bot) throws ServiceException {
        User telegramUser = telegramApiService.getMe(bot.getToken());
        updateBotFromTgUser(bot, telegramUser);
    }
